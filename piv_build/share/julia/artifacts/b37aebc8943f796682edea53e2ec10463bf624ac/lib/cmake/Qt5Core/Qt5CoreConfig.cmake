...
set(Qt5Core_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/lib/QtCore.framework/Versions/5/Headers/5.15.3/"
        "${_qt5Core_install_prefix}/lib/QtCore.framework/Versions/5/Headers/5.15.3/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Core
                 ...
                 etw;futimes;getauxval;getentropy;glib;glibc;gnu-libiconv;icu;posix-libiconv;iconv;inotify;journald;linkat;lttng;system-pcre2;poll_ppoll;poll_pollts;poll_select;renameat2;slog2;statx;syslog;system-doubleconversion)
    ...
    _populate_Core_target_properties(RELEASE "QtCore.framework/QtCore" "" FALSE)
