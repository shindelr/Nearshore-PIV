...
set(Qt5Sql_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/lib/QtSql.framework/Versions/5/Headers/5.15.3/"
        "${_qt5Sql_install_prefix}/lib/QtSql.framework/Versions/5/Headers/5.15.3/QtSql"
    )
    ...
    foreach(_module_dep ${_Qt5Sql_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Sql_FIND_VERSION_EXACT}
    ...
    _populate_Sql_target_properties(RELEASE "QtSql.framework/QtSql" "" FALSE)
