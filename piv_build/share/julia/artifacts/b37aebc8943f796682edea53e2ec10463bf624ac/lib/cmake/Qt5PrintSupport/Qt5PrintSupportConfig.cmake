...
set(Qt5PrintSupport_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/lib/QtPrintSupport.framework/Versions/5/Headers/5.15.3/"
        "${_qt5PrintSupport_install_prefix}/lib/QtPrintSupport.framework/Versions/5/Headers/5.15.3/QtPrintSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PrintSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5PrintSupport_FIND_VERSION_EXACT}
    ...
    _populate_PrintSupport_target_properties(RELEASE "QtPrintSupport.framework/QtPrintSupport" "" FALSE)
