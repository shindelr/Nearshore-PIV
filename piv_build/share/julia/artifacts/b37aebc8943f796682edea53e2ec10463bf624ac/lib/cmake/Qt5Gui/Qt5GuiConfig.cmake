...
set(Qt5Gui_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/lib/QtGui.framework/Versions/5/Headers/5.15.3/"
        "${_qt5Gui_install_prefix}/lib/QtGui.framework/Versions/5/Headers/5.15.3/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 freetype;gif;harfbuzz;ico;imageio-text-loading;jpeg;multiprocess;png;raster-64bit;system-freetype;tuiotouch;vkgen)
    set_property(TARGET Qt5::Gui
    ...
    _populate_Gui_target_properties(RELEASE "QtGui.framework/QtGui" "" FALSE)
