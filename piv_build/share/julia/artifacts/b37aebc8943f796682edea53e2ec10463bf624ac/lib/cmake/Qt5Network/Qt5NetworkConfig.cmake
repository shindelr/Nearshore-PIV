...
set(Qt5Network_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/lib/QtNetwork.framework/Versions/5/Headers/5.15.3/"
        "${_qt5Network_install_prefix}/lib/QtNetwork.framework/Versions/5/Headers/5.15.3/QtNetwork"
    )
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Network_FIND_VERSION_EXACT}
    ...
    _populate_Network_target_properties(RELEASE "QtNetwork.framework/QtNetwork" "" FALSE)
