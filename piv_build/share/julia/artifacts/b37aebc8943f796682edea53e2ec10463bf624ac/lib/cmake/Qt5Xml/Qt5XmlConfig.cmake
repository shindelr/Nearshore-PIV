...
set(Qt5Xml_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/lib/QtXml.framework/Versions/5/Headers/5.15.3/"
        "${_qt5Xml_install_prefix}/lib/QtXml.framework/Versions/5/Headers/5.15.3/QtXml"
    )
    ...
    foreach(_module_dep ${_Qt5Xml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Xml_FIND_VERSION_EXACT}
    ...
    _populate_Xml_target_properties(RELEASE "QtXml.framework/QtXml" "" FALSE)
