...
set(Qt5Widgets_VERSION_STRING 5.15.3)
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/lib/QtWidgets.framework/Versions/5/Headers/5.15.3/"
        "${_qt5Widgets_install_prefix}/lib/QtWidgets.framework/Versions/5/Headers/5.15.3/QtWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    _populate_Widgets_target_properties(RELEASE "QtWidgets.framework/QtWidgets" "" FALSE)
